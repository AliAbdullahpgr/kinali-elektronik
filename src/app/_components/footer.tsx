        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-gold hover:text-brand-dark transition-colors cursor-pointer">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3 8h6v1h-6v-1zm3 8c-2.347 0-4.48-1.034-5.918-2.657l1.378-1.528c1.071 1.206 2.655 1.968 4.408 1.968 1.769 0 3.368-.778 4.444-2l1.328 1.554c-1.428 1.671-3.602 2.748-5.969 2.748l.329.006z"/></svg>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-brand-gold mb-6">Hızlı Erişim</h3>
            <ul className="space-y-3 text-sm text-gray-400">
              {['Telefon Tamiri', 'Tablet Servisi', 'TV Onarım', 'Aksesuar', 'Yedek Parça'].map((item) => (
                <li key={item}>
          ...
          {/* Column 3: Contact */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-brand-gold mb-6">İletişim</h3>
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex items-start gap-3">
                ...
                <span>Merkez Mah. Fevzi Çakmak Cad. No:12/A<br/>Güngören / İstanbul</span>
              </li>
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-brand-gold mb-6">Çalışma Saatleri</h3>
